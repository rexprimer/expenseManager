...
public class UserServiceImpl implements UserService {
	...
	public User createUser(UserModel user) {
		logger.debug("Checking for existing user with email: {}", user.getEmail());
	...
	public User updateUser(UserModel user) {
		...
		logger.info("Updating user details for: {}", existingUser.getEmail());
	...
	public void deleteUser() {
		User existingUser = readUser();
		logger.info("Deleting user: {}", existingUser.getEmail());
	...
	public User getLoggedInUser() {
		...
		logger.info("Fetching details for logged-in user: {}", email);
